...
pacman::p_load(jsonlite, tidygraph, ggraph, 
               ...
               skimr, tidytext, tidyverse,tm,topicmodels,reshape2,ggplot2,wordcloud,pals,Snowballac,Lda,Ldatuning,kableExtra,DT,flextable,remotes,ldatuning)
```
...
To determine the optimal number of topics, using the "Deveaud2014" metric for topic coherence, select 4 topics that yields a higher value, indicating a stronger degree of similarity between words within each topic.
