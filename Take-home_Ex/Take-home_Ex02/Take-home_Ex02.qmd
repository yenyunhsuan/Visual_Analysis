...
## Filter by hscode
Filter the companies that either appearing in source and target, and other companies having relationships with them.
Then filter hscode of 401120, that the company with the most out-degree has the most weight.
