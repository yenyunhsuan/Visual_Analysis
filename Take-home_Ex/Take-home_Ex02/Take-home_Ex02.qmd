...
```{r}
pacman::p_load(jsonlite, tidygraph, ggraph, visNetwork, lubridate, tidyverse, visNetwork,heatmaply,dply,ggplot2,ggpubr,RColorBrewer, igraph)
```
...
visNetwork(nodes, MC2_edge_irregular, main = "Overall Business pattern") %>%
