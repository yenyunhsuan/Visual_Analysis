...
We observe that the fishers typically send shipments to all the top receivers (wholesalers), but not all wholesalers receive shipments from all the fishers.
